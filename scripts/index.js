...
console.log('оливье' > 'ананас');// т.к. а будет первая буква алфавита и тем самым меньше последующих букв алфавита
console.log('кодировка' > 'котировка'); //буква 'д' в алфавите первее будет чем буква 'т'
...
for (let i = myFavoritePerformers.length -1; i >=0; i --){
   if (i % 2 == 0){
